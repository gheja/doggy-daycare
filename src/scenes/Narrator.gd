...
var texts = [
	...
	[ # 3 - finger locked (on first level)
		...
		[ "You just noticed you're starving, the food is in the kitchen, across the hallway.", preload("res://assets/sounds/you_just_noticed_you_re_starving_the_food_is_in_the_kitchen_across_the_hallway_1709163091_tts-1_fable.ogg") ],
	...
	[ # 10 - thanks for playing
		[ "You did great and finished all levels.", preload("res://assets/sounds/you_did_great_and_finished_all_levels_1709165481_tts-1_fable.ogg") ],
